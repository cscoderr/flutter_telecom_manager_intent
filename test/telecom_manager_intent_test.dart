...
void main() {
  final TelecomManagerIntentPlatform initialPlatform = TelecomManagerIntentPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockTelecomManagerIntentPlatform fakePlatform = MockTelecomManagerIntentPlatform();
